window.addEventListener("DOMContentLoaded", () => {
    ...
    const percentageOverlayText = document.querySelector(".hero_percentage-container > .hero_percentage-container-text");
    const customCursor = document.querySelector(".custom-cursor");
    
    const customCursorContent = document.querySelector(".custom-cursor > .custom-cursor-content");
    ...
    let ctx = gsap.context(() => {
        ...
        gsap.set(".container-hamburger-menu ", { opacity: 0, pointerEvents: "none" });
        ...
        gsap.set([layerContainerAll, projectMenuItemAll], { clipPath: " inset(0% 51% 0% 49%)" })
        ...
        const handleCloseHomePage = () => {
            ...
            cpl.play(0)
                ...
                .to(".container-hamburger-menu", {
                    opacity: 1,
                    pointerEvents: "auto",
                    duration: 0
                }, "<95%").add(() => hmtl.play()).to(".title-hamburger-menu", {
                    delay: 0.2,
                    clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)"
                })
                .to(projectMenuItemAll, {
                    clipPath: " inset(0% 0% 0% 0%)",
                    duration: 1,
                    ease: "expo",
                    stagger: 0.1
                }, "-=0.5")
                .to(layerContainerAll, {
                    clipPath: " inset(0% 0% 0% 0%)",
                    duration: 0.5,
                    delay: 0.001,
                    ease: "sine.inOut",
        ...
        links.forEach((link) => {
            ...
            const split = SplitText.create(
                link.querySelectorAll(".nav-link__text"),
        ...
        mm.add({
            ...
            gsap.set(".hero-title", { yPercent: isDesktop ? -120 : -400, scale: isDesktop ? 0.5 : 1 });
            ...
            hl.to(".hero-bg", {
                ...
                .to(".hero-title", { yPercent: isDesktop ? -40 : -200, duration: 1, ease: "power4" }, "<")
                .to(".logo-img", { yPercent: 20, scale: 1.5, duration: 1, ease: "power4" }, "<")
                .to(".hero-bg", {
        ...
        projectMenuItemAll.forEach((item) => {
            ...
            const titleMenuProjectTop = item.querySelector(".title-menu-project-top span");
            const titleMenuProjectBottom = item.querySelector(".title-menu-project-bottom span");
            ...
            item.addEventListener("mouseleave", () => {
                ...
                tl.to(idChars, { yPercent: 0, stagger: 0.02, duration: 0.3, ease: "expo.inOut" }, 0)
                    .to(titleTopChars, { yPercent: 0, stagger: 0.02, duration: 0.3, ease: "expo.inOut" }, 0)
                    .to(titleBottomChars, { yPercent: 0, stagger: 0.02, duration: 0.3, ease: "expo.inOut" }, 0);
            });
        });
        ...
        function changeCursorText(newText) {
            ...
            tl.to(customCursor, {
                ...
                .call(() => { customCursorContent.textContent = newText; })
                .to(customCursor, {
                    scaleX: 1,
                    scaleY: 1,
                    duration: 0.5,
        ...
        overlaySection.forEach((item) => {
            ...
            const overlaySubtitleChars = SplitText.create(overlaySubtitle, { type: "chars" });
            const overlayDescriptionChars = SplitText.create(overlayDescription, { type: "chars" });
            const overlayTitleChars = SplitText.create(overlayTitle, { type: "chars" });
            ...
            gsap.fromTo(overlaySubtitleChars.chars,
                { yPercent: 100 },
                {
                    stagger: 0.04,
                    yPercent: 0,
            ...
            gsap.fromTo(overlayDescriptionChars.chars,
                { yPercent: 100 },
                {
                    stagger: 0.02,
                    yPercent: 0,
            ...
            gsap.fromTo(overlayTitleChars.chars,
                { yPercent: 100 },
                {
                    stagger: 0.05,
                    yPercent: 0,
