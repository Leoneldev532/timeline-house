window.addEventListener("DOMContentLoaded", function () {
  ...
  const scrollImageSequenceStep = document.querySelectorAll(
    ".hero-sequence__step",
  );
  ...
  const infiniteTextHeroAnimated = gsap.utils.toArray(
    ".hero__animated-text-item",
  );
  ...
  const animate = () => {
    ...
    gsap.fromTo(
      ...
      { y: 40, opacity: 0 },
      {
        ...
        ease: "power3.out",
        onComplete: () => {
          scrollImageSequenceStep.forEach((item) =>
